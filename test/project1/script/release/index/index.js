...
modules['8'] = (function(){
	var exports = module.exports = {};
module.exports = ".filter{display:block;} .price, .type{float:left;}"
	return module.exports;
})();
modules['2'] = (function(){
	var exports = module.exports = {};
...
module.exports = function(placeNode){
	...
	var node = base.toNode('<div><div marker=\'price\'>价格</div><div marker="type">房型</div></div>');
